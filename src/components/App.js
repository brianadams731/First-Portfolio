    ...
    <div className="app-wrap" onClick={unMountAllMod}>
      ...
      <motion.div key="wideSvg" className="wide-svg-wrap">
        <svg className="main-svg" viewBox="0 0 1440 378" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/*Red*/}
          <motion.circle onClick={(e)=>{clickModSetUp(e,"projects","elderLawForm")}} onMouseEnter={(e)=>{hoverModSetUp(e,"projects","elderLawForm")}} onMouseLeave={unMountHoverMod} initial={"hovInitial"} variants={hoverVer} whileTap={"click"} whileHover={"active"} animate={"popIn"} className="circle" cx="194" cy="179" r="20"/>
          <motion.circle onClick={(e)=>{clickModSetUp(e,"projects","sideScroller")}} onMouseEnter={(e)=>{hoverModSetUp(e,"projects","sideScroller")}} onMouseLeave={unMountHoverMod} initial={"hovInitial"} variants={hoverVer} whileTap={"click"} whileHover={"active"} animate={"popIn"} className="circle" cx="526" cy="179" r="20"/>
          <motion.circle onClick={(e)=>{clickModSetUp(e,"projects","recypher")}} onMouseEnter={(e)=>{hoverModSetUp(e,"projects","recypher")}} onMouseLeave={unMountHoverMod} initial={"hovInitial"} variants={hoverVer} whileTap={"click"} whileHover={"active"} animate={"popIn"} className="circle" cx="823" cy="85" r="20"/>
          <motion.circle onClick={(e)=>{clickModSetUp(e,"projects","soulShine")}} onMouseEnter={(e)=>{hoverModSetUp(e,"projects","soulShine")}} onMouseLeave={unMountHoverMod} initial={"hovInitial"} variants={hoverVer} whileTap={"click"} whileHover={"active"} animate={"popIn"} className="circle" cx="1259" cy="85" r="20"/>

          {/*Blue*/}
          <motion.circle onMouseEnter={(e)=>{hoverModSetUp(e,"contact","connect")}} onMouseLeave={unMountHoverMod} onClick={(e)=>contactModSetUp(e,"contact","connect")} initial={"hovInitial"} variants={hoverVer} whileTap={"click"} whileHover={"active"} animate={"popIn"} className="circle" cx="289" cy="103" r="20"/>
          <motion.circle onMouseEnter={(e)=>{hoverModSetUp(e,"contact","form")}} onMouseLeave={unMountHoverMod} onClick={(e)=>contactModSetUp(e,"contact","form")} initial={"hovInitial"} variants={hoverVer} whileTap={"click"} whileHover={"active"} animate={"popIn"} className="circle" cx="1149" cy="359" r="20"/>

          {/*Green*/}
          <motion.circle onMouseEnter={(e)=>{hoverModSetUp(e,"about","skills")}} onMouseLeave={unMountHoverMod} onClick={(e)=>aboutModSetUp(e,"about","skills")} initial={"hovInitial"} variants={hoverVer} whileTap={"click"} whileHover={"active"} animate={"popIn"} className="circle" cx="555" cy="19" r="20"/>
          <motion.circle onMouseEnter={(e)=>{hoverModSetUp(e,"about","interests")}} onMouseLeave={unMountHoverMod} onClick={(e)=>aboutModSetUp(e,"about","interests")} initial={"hovInitial"} variants={hoverVer} whileTap={"click"} whileHover={"active"} animate={"popIn"} className="circle" cx="789" cy="246" r="20"/>
        </svg>
      </motion.div>
      :
      <motion.div key="narrowSvg" className="narrow-svg-wrap">
        <svg className="main-svg" viewBox="0 0 218 604" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <motion.g onClick={(e)=>{clickModSetUp(e,"projects","elderLawForm")}} initial={"hovInitial"} variants={hoverVer} animate={"popIn"} className="hovPoint">
            <circle r="18" cx="19" cy="123" className="mobCircle"/>
          ...
          <motion.g onClick={(e)=>{clickModSetUp(e,"projects","sideScroller")}} initial={"hovInitial"} variants={hoverVer} animate={"popIn"} className="hovPoint">
            <circle r="18" cx="109" cy="358" className="mobCircle"/>
          ...
          <motion.g onClick={(e)=>{clickModSetUp(e,"projects","soulShine")}} initial={"hovInitial"} variants={hoverVer} animate={"popIn"} className="hovPoint">
            <circle r="18"  cx="199" cy="447" className="mobCircle"/>
          ...
          <motion.g onClick={(e)=>{clickModSetUp(e,"projects","recypher")}} initial={"hovInitial"} variants={hoverVer} animate={"popIn"} className="hovPoint">
            <circle r="18" cx="199" cy="539" className="mobCircle"/>
          ...
          <motion.g onClick={(e)=>{aboutModSetUp(e,"about","skills")}} initial={"hovInitial"} variants={hoverVer} animate={"popIn"} className="hovPoint">
            <circle r="18" cx="199" cy="161" className="mobCircle"/>
          ...
          <motion.g onClick={(e)=>{aboutModSetUp(e,"about","interests")}} initial={"hovInitial"} variants={hoverVer} animate={"popIn"} className="hovPoint">
            <circle r="18" cx="19" cy="338" className="mobCircle"/>
          ...
          <motion.g onClick={(e)=>{contactModSetUp(e,"contact","connect")}} initial={"hovInitial"} variants={hoverVer} animate={"popIn"} className="hovPoint">
            <circle r="18" cx="109" cy="85" className="mobCircle"/>
          ...
          <motion.g onClick={(e)=>{contactModSetUp(e,"contact","form")}} initial={"hovInitial"} variants={hoverVer} animate={"popIn"} className="hovPoint">
            <circle r="18" cx="109" cy="493" className="mobCircle"/>
