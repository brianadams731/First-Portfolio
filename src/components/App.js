    ...
    <div className="app-wrap" onClick={unMountAllMod}>
      ...
      <motion.div key="wideSvg" className="wide-svg-wrap">
        <svg viewBox="0 0 1440 378" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/*Red*/}
          <motion.circle onClick={(e)=>{clickModSetUp(e,"projects","recypher")}} onMouseEnter={(e)=>{hoverModSetUp(e,"projects","recypher")}} onMouseLeave={unMountHoverMod} initial={"hovInitial"} variants={hoverVer} whileTap={"click"} whileHover={"active"} animate={"popIn"} className="circle" cx="194" cy="179" r="20" fill="#ffb487"/>
          ...
          <motion.circle onClick={(e)=>{clickModSetUp(e,"projects","soulShine")}} onMouseEnter={(e)=>{hoverModSetUp(e,"projects","soulShine")}} onMouseLeave={unMountHoverMod} initial={"hovInitial"} variants={hoverVer} whileTap={"click"} whileHover={"active"} animate={"popIn"} className="circle" cx="823" cy="85" r="20" fill="#ffb487"/>
          <motion.circle onClick={(e)=>{clickModSetUp(e,"projects","elderLawForm")}} onMouseEnter={(e)=>{hoverModSetUp(e,"projects","elderLawForm")}} onMouseLeave={unMountHoverMod} initial={"hovInitial"} variants={hoverVer} whileTap={"click"} whileHover={"active"} animate={"popIn"} className="circle" cx="1259" cy="85" r="20" fill="#ffb487"/>
      ...
      <motion.div key="narrowSvg" className="narrow-svg-wrap">
        <svg viewBox="0 0 218 604" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* PROJECTS */}
          <motion.g onClick={(e)=>{clickModSetUp(e,"projects","elderLawForm")}} initial={"hovInitial"} variants={hoverVer} animate={"popIn"}>
            <circle cx="19" cy="123" r="19" fill="#FFDAC1"/>
          ...
          <motion.g onClick={(e)=>{clickModSetUp(e,"projects","sideScroller")}} initial={"hovInitial"} variants={hoverVer} animate={"popIn"}>
            <circle cx="109" cy="358" r="19" fill="#FFDAC1"/>
          ...
          <motion.g onClick={(e)=>{clickModSetUp(e,"projects","soulShine")}} initial={"hovInitial"} variants={hoverVer} animate={"popIn"}>
            <circle  cx="199" cy="447" r="19" fill="#FFDAC1"/>
          ...
          <motion.g onClick={(e)=>{clickModSetUp(e,"projects","recypher")}} initial={"hovInitial"} variants={hoverVer} animate={"popIn"}>
            <circle cx="199" cy="539" r="19" fill="#FFDAC1"/>
          ...
          {/* ABOUT */}
          <motion.g onClick={(e)=>{aboutModSetUp(e,"about","skills")}} initial={"hovInitial"} variants={hoverVer} animate={"popIn"}>
            <circle cx="199" cy="161" r="19" fill="#FFDAC1"/>
          ...
          <motion.g onClick={(e)=>{aboutModSetUp(e,"about","interests")}} initial={"hovInitial"} variants={hoverVer} animate={"popIn"}>
            <circle cx="19" cy="338" r="19" fill="#FFDAC1"/>
          ...
          {/* CONTACT */}
          <motion.g onClick={(e)=>{contactModSetUp(e,"contact","connect")}} initial={"hovInitial"} variants={hoverVer} animate={"popIn"}>
            <circle cx="109" cy="85" r="19" fill="#FFDAC1"/>
          ...
          <motion.g onClick={(e)=>{contactModSetUp(e,"contact","form")}} initial={"hovInitial"} variants={hoverVer} animate={"popIn"}>
            <circle cx="109" cy="493" r="19" fill="#FFDAC1"/>
