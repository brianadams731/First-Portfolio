    ...
    return(
        <motion.div onClick={(e)=>e.stopPropagation()} initial={{opacity:0}} animate={{opacity:1}} exit={{opacity:0}}  transition={{duration:.3}} className="click-mod-wrapper">
            <div className="exit" onClick={props.exit}>
                <motion.svg whileHover={{stroke:"#F0717B", scale:1.2}} whileTap={{scale:1}} strokeWidth="5" stroke="#FFFFFF" width="20px" height="20px" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
